              ...
              <div class="user-account-info between-center">
                <div class="user-account-main">
                  ...
                  <div class="user-balance">
                    2.014095 <small class="currency currency-btc">BTC</small>
                  </div>
                  <div class="user-balance-alt">
                    18,934.84 <span class="currency currency-btc">BTC</span>
                  </div>
                </div>
                ...
                <li>
                  ...
                  <div class="user-account-value">
                    <span class="lead-text"
                      >+ 0.0526
                      <span class="currency currency-btc">BTC</span></span
                    >
                  ...
                  <ul class="nk-menu-sub">
                    <li class="nk-menu-item">
                      <a href="html/crypto/welcome.html" class="nk-menu-link"
                        ><span class="nk-menu-text">Welcome</span></a
                      >
                    </li>
                    <li class="nk-menu-item">
                      <a
                        ...
                        class="nk-menu-link"
                        ><span class="nk-menu-text">KYC - Get Started</span></a
                      >
                    </li>
                    <li class="nk-menu-item">
                      <a href="html/crypto/kyc-form.html" class="nk-menu-link"
                  ...
                  <a href="#">
                    ...
                    <div class="wallet-text">
                      ...
                      <span class="wallet-balance"
                        >30.959040
                        <span class="currency currency-nio">NIO</span></span
                      >
                    </div>
                  </a>
                </li>
                          ...
                          <div class="nk-wgw sm">
                            ...
                            >
                              ...
                              <div class="nk-wgw-balance">
                                <div class="amount">
                                  4.434953<span class="currency currency-nio"
                                    >NIO</span
                                  >
                                </div>
                              </div>
                        ...
                        <div class="card bg-light">
                          <div class="nk-wgw sm">
                            ...
                            >
                              ...
                              <div class="nk-wgw-balance">
                                <div class="amount">
                                  4.434953<span class="currency currency-btc"
                                    >BTC</span
                                  >
                                </div>
                              </div>
                        ...
                        <div class="card bg-light">
                          <div class="nk-wgw sm">
                            ...
                            >
                              ...
                              <div class="nk-wgw-balance">
                                <div class="amount">
                                  0.000560<span class="currency currency-eth"
                                    >ETH</span
                                  >
                                </div>
                              </div>
                    ...
                    <div class="tranx-item">
                      ...
                      <div class="tranx-col">
                        <div class="tranx-amount">
                          <div class="number">
                            1.538405
                            <span class="currency currency-btc">ETH</span>
                          </div>
                          <div class="number-sm">
                            1,176.34
                            <span class="currency currency-usd">USD</span>
